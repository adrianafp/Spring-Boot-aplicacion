package com.adrianaf.springBoot_aplicacion.dto;
...
public class ChangePasswordForm {
	...
	@NotBlank(message="La password actual no puede estar vacía")
	private String currentPassword;
	
	@NotBlank(message="La password nueva no puede estar en blanco")
	private String newPassword;
	
	@NotBlank(message="La nueva password debe ser confirmada")
